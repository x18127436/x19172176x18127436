class MeetingsController < ApplicationController
  ...
  def create
    ...
    card_brand = params.dig(:user, :card_brand)
    card_exp_month = params.dig(:user, :card_exp_month)
    card_exp_year = params.dig(:user, :card_exp_year)
    card_last4 = params.dig(:user, :card_last4)
